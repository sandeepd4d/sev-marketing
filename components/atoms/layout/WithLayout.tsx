...
export default function WithLayout({
    ...
    const [displayLeftBottom, setDisplayLeftBottom] = useState(showLeftBottom ?? false);
    ...
    const [rightPanelBtnClick, setRightPanelBtnClick] = useState({onRightPanelBtnClick})
    ...
    const importImg = '/images/slogan.png';
                    ...
                    {!hideLeftPanel && (
                        <>
                            {/* <Box className={`${bannerStyle.banner} location_banner`}>
                                ...
                                <img src={importImg} alt="This is an image" width={160} height={44} className={bannerStyle.bannerImg} />
                                <Typography variant="h2" className={bannerStyle.bannerHeading}>LOREM IPSUM</Typography>
                                <Typography className={bannerStyle.bannerContent}>Have an account ?<Link href="#" className={bannerStyle.bannerLink}> Sign In</Link></Typography>
                                </Box>
                            </Box> */}
                            <Grid item className={`${classes.left}`} sx={{height:'100%'}}>
                                {/* {!isMobile && <LeftSummary />} */}
                                {leftPanel}
                                {showLoader && (
                                    <Box position="absolute" className={classes.loader}>
                                ...
                                {displayBottom && (
                                    <Box className={classes.continueBtnWrap}>
                                        <Button
                                            variant="contained"
                                            color="primary"
                                            className={classes.continueBtn}
